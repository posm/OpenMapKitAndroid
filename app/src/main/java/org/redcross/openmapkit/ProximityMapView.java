 ...
 */
public class ProximityMapView extends MapView {
    private UserProximityOverlay mLocationOverlay;

    public ProximityMapView(final Context aContext) {
        super(aContext, 256, null, null, null);
    }

    public ProximityMapView(final Context aContext, AttributeSet attrs) {
        super(aContext, 256, null, null, attrs);
    }

    protected ProximityMapView(Context aContext, int tileSizePixels, MapTileLayerBase aTileProvider) {
        super(aContext, tileSizePixels, aTileProvider, null, null);
    }

    private UserProximityOverlay getOrCreateLocationOverlay() {
     ...
     */
    public UserProximityOverlay.TrackingMode getUserProximityTrackingMode() {
        if (mLocationOverlay != null) {
            return mLocationOverlay.getTrackingMode();
        }
        return UserProximityOverlay.TrackingMode.NONE;
    }
     ...
     */
    public UserProximityOverlay getUserProximityOverlay() {
        return mLocationOverlay;
    }
